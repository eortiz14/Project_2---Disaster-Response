...
def load_data(messages_filepath, categories_filepath):
    ...
    '''
    load_data loads and merges .csv data from message and categories 
...
def clean_data(df):
    '''
    clean_data cleans the dataframe data and generates binary responses for MultiClassifier
    
    Input:
    df: Merged DataFrame using pandas
       
    output: 
    df: DataFrame suitable for modelling
    '''
